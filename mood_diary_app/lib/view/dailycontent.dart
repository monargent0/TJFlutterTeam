            ...
            child: Row(
              children: [
                ...
                GestureDetector(
                  ...
                  child: Column(
                    children: [
                      const CircleAvatar(                   // db에서 받아온 이미지패스경로받기
                      ...
                      Text(
                        // 이미지 이름
                        '완벽해',
                        style: enameEdit == '완벽해' ? const TextStyle(
                          color: Colors.green,
                ...
                GestureDetector(
                  ...
                  child: Column(
                    children: [
                      CircleAvatar(                   // db에서 받아온 이미지패스경로받기
                      ...
                      Text(
                        // 이미지 이름
                        '너무행복해',
                        style: enameEdit == '너무행복해' ? TextStyle(
                          color: Colors.green,
                          fontWeight: FontWeight.bold
                        ) : TextStyle(
                          color: Colors.black,
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        // 이미지 이름
                        '행복해',
                        style: enameEdit == '행복해' ? const TextStyle(
                          color: Colors.green,
                          fontWeight: FontWeight.bold
                        ) : const TextStyle(
                          color: Colors.black,
                ...
                GestureDetector(
                  ...
                  child: Column(
                    children: [
                      const CircleAvatar(                   // db에서 받아온 이미지패스경로받기
                        backgroundImage: AssetImage('images/soso.png'/*emotionPath */ ),
                        radius: 50,
                      ),
                      const SizedBox(
                        height: 10,
                      ...
                      Text(
                        // 이미지 이름
                        '그냥그래',
                        style: enameEdit == '그냥그래' ? const TextStyle(
                          color: Colors.green,
                          fontWeight: FontWeight.bold
                        ) : const TextStyle(
                          color: Colors.black,
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        // 이미지 이름
                        '슬퍼',
                        style: enameEdit == '슬퍼' ? const TextStyle(
                          color: Colors.green,
                          fontWeight: FontWeight.bold
                        ) : const TextStyle(
                          color: Colors.black,
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        // 이미지 이름
                        '아파',
                        style: enameEdit == '아파' ? const TextStyle(
                          color: Colors.green,
                          fontWeight: FontWeight.bold
                        ) : const TextStyle(
                          color: Colors.black,
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        // 이미지 이름
                        '기분나빠',
                        style: enameEdit == '기분나빠' ? const TextStyle(
                          color: Colors.green,
                          fontWeight: FontWeight.bold
                        ) : const  TextStyle(
                          color: Colors.black,
...
>>>>>>> parent of 8180ced (Merge branch 'main' into jiheok)
    );
  }
}
