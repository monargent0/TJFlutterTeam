...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    String whereDefault ="select d.did, d.ddate, d.dcontent, d.eid, d.uid , e.epath from diary d , emotion e where d.eid = e.eid and d.uid = 'jung' order by ddate desc";
